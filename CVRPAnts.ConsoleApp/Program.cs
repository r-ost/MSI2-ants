...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        try
        {
            ...
            var acoSolver = new AntColonySolver(parameters, 420, null);
        ...
        try
        {
            ...
            var aco2OptSolver = new AntColony2OptSolver(parameters, 420, null);
        ...
        try
        {
            ...
            var acoMaxMinSolver = new AntColonyMaxMinSolver(parameters, 420, null)
            {
                PheromoneMin = 0.01,
                PheromoneMax = 10.0,
